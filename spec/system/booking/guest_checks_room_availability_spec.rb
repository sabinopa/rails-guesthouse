...
describe 'Guest checks availability of a room' do
  ...
  it 'and room is not available in the period' do
    ...
    booking = Booking.create!(guest: first_guest, host: host, start_date: 2.days.from_now, end_date: 4.days.from_now, number_guests: '2', room: room, prices: 200.0, status: 2)
